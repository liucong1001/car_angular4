...
@Component({
  selector: 'ngx-vehicle-daytrade',
  templateUrl: './vehicle-daytrade.component.html',
  styleUrls: ['./vehicle-daytrade.component.scss'],
...
export class VehicleDaytradeComponent implements OnInit, OnChanges {
