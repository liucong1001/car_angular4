...
const routes: Routes = [{
  ...
  children: [
    ...
    {path: 'market/market/basic', component: MarketBasicComponent},
    {path: 'market/market/basic/add', component: MarketBasicAddComponent},
    {path: 'market/market/basic/edit', component: MarketBasicEditComponent},
