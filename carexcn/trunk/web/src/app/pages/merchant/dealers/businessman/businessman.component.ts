...
import {SonMerchantForm} from '../../../../@core/model/business/son.merchant.form';
 ...
 */
@Component({
  selector: 'ngx-businessman',
  templateUrl: './businessman.component.html',
  styleUrls: ['./businessman.component.scss'],
})
export class BusinessmanComponent implements OnInit, OnChanges {
  ...
  /*跳转*/
  jump() {
    this.router.navigateByUrl('/pages/merchant/businessman/add');
  }
  ...
  linkman(merchant) {
    this.router.navigate( ['/pages/merchant/businessman/linkman', { id: merchant.id}]);
  ...
  edit(merchant) {
    this.router.navigate( ['/pages/merchant/businessman/edit', { id: merchant.id}]);
    // console.info(merchant);
  }
