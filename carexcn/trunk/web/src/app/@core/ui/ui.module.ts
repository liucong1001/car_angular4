...
@NgModule({
  entryComponents: [],
  exports: [UiTableModule, CameraComponent, CalendarComponent, AutoinputComponent, CodeitemDroplistComponent, DroplistComponent],
  imports: [FormsModule, UiTableModule, RouterModule, FileUploadModule, CalendarModule, AutoCompleteModule, DropdownModule],
  declarations: [CameraComponent, CameraUploadComponent, CalendarComponent, AutoinputComponent, CodeitemDroplistComponent, DroplistComponent],
})
